...
int main(int argc, char *argv[])
{
	...
	if(argc <= 1){
		...
		cout << "Client A ends with error: no argument" << endl;
		return 1;
	}
    ...
    serverM_addr.sin_port = htons(Ports::serverM_A);
    ...
    cout << "Client A is up and running" << endl;
    ...
    switch(argc)
    {
    	case 2:
    		...
    		{
    			cout << "ClientA sent a sorted list request to the mainserver." << endl;
	            ...
	            if(response[0].compare("successed") == 0)
	            {
	            	...
	            	cout << "ClientA ends with unknown error" << endl;
	            }
    	...
    	case 3:
    		cout << argv[1] << " requested for the summary sheet." << endl;
            ...
            if(response[0].compare("successed") == 0){
            	cout << "The transcation table is" << endl;
            } else {
            	cout << "Unknown Error" << endl;
            }
